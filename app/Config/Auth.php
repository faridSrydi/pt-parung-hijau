...
class Auth extends ShieldAuth
{
    ...
    public function loginRedirect(): string
    {
        ...
        if ($user) {
            ...
            if ($user->inGroup('produksi')) {
                return base_url('produksi/dashboard');
            }
            if ($user->inGroup('distribusi')) {
                return base_url('distribusi/dashboard');
            }
            if ($user->inGroup('pelanggan')) {
                return base_url('pelanggan/dashboard');
            }
        }
